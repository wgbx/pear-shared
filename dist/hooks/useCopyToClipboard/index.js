...
export function useCopyToClipboard() {
  var _useAlert = useAlert(),
    success = _useAlert.success,
    error = _useAlert.error;
  var copyToClipboard = useMemoizedFn( /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            successMessage = options.successMessage, errorMessage = options.errorMessage, onSuccess = options.onSuccess, onError = options.onError;
            _context.prev = 3;
            _context.next = 6;
