...
Click **Trigger error** to throw during render. The boundary shows `fallbackComponent`. Click **Reset** to remount and recover.
...
If `fallbackComponent` is omitted, the errored region renders nothing (`null`).
